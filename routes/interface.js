...
(function () {
  ...
  router.get('/index.html', function (req, res) {
    res.render('interface', {
      ...
      js: ['/lib/json-editor/dist/jsoneditor.js', '/lib/angular-json-editor/dist/angular-json-editor.js', '/lib/mockjs/dist/mock-min.js', '/lib/underscore/underscore-min.js', '/lib/angular-validation/dist/angular-validation.min.js', '/lib/angular-xeditable/dist/js/xeditable.js', '/javascripts/rule.js', '/javascripts/interface.js']
    });
