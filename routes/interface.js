...
(function () {
  ...
  router.get('/index.html', function (req, res) {
    res.render('interface', {
      ...
      js: ['/lib/Validator/validator.js', '/lib/jquery/dist/jquery.min.js', '/lib/bootstrap/dist/js/bootstrap.min.js', '/lib/angular-validation/dist/angular-validation.min.js', '/javascripts/rule.js', '/lib/underscore/underscore-min.js', '/javascripts/interface.js']
    });
